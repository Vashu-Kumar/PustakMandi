...
//   // Handle search changes & send to parent
...
//         {/* 🌐 MOBILE NAVBAR (xs to sm) - Display: flex for xs/sm, none for md and up */}
//         <Box sx={{ display: { xs: "flex", md: "none" } }} className="items-center gap-3">
...
//               className="border border-gray-400 bg-transparent rounded-md px-2 py-1 text-white text-sm w-[130px] focus:outline-none focus:ring-2 focus:ring-yellow-400"
//             />
//             <FaSearch className="text-lg text-yellow-400 cursor-pointer hover:text-yellow-300" />
//           </div>
...
//         {/* 🖥️ DESKTOP NAVBAR (md and above) - Display: none for xs/sm, flex for md and up */}
//         <Box
//           // Switched from Tailwind hidden md:flex to MUI sx display
//           sx={{ flexGrow: 1, display: { xs: "none", md: "flex" } }}
//           className="justify-center items-center"
//         >
//           <div className="bg-white rounded-full shadow-md ring-1 ring-slate-900/5 px-6 py-2 gap-x-5 xl:gap-x-7 flex items-center">
...
//         {/* 🔍 DESKTOP SEARCH (md and above) - Display: none for xs/sm, flex for md and up */}
//         <Box
//           // Switched from Tailwind hidden md:flex to MUI sx display
//           sx={{ display: { xs: "none", md: "flex" } }}
//           className="items-center gap-2 ml-4"
//         >
//           <input
//             type="text"
//             placeholder="Search Book..."
//             value={searchQuery}
//             onChange={handleSearchChange}
//             className="border border-gray-400 bg-transparent rounded-md px-2 py-1 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
//           />
//           <FaSearch className="text-xl text-yellow-400 cursor-pointer hover:text-yellow-300" />
//         </Box>


//         {/* 👤 Avatar (User Menu) - Visibility remains the same */}
//         {user && (
//           <Box sx={{ ml: 2 }}>
