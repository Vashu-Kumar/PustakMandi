        ...
        {blogs.map((blog) => {
          return (
            <div key={blog.title} className="relative">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, atque! Obcaecati omninus consequuntur.</p>
              <button className="underline mt-2 bold-16 line-clamp-2">continue reading..</button>
            </div>
          )
        })}
      </div>
