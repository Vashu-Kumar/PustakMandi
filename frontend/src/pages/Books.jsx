...
// //   // ✅ Fetch books — uses the same backend endpoint for both MongoDB & Gutendex
...
// //   // 🟢 Load all MongoDB books initially
// //   useEffect(() => {
// //     fetchBooks();
// //   }, []);

// //   // 🔍 Handle search (triggered by Header)
...
//   // 🟢 Load all MongoDB books on initial mount
//   useEffect(() => {
//     fetchBooks();
//   }, []);

//   // 🔍 Handle search (triggered from Header component)
//   const handleSearch = (query) => {
//     fetchBooks(query);
//   };

//   // 🧭 Handle book click → navigate based on book source
//   const handleBookClick = (book) => {
//     if (book.source === "gutenberg") {
//       // Gutendex books → navigate using encoded title
//       navigate(`/PustakMandi/book/${encodeURIComponent(book.title)}`);
//     } else {
//       // MongoDB books → navigate using _id
