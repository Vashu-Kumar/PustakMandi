...
const Contact = () => {
    return (
        <div className="pt-18 pb-30 min-h-screen   text-black">
            <div className="max-w-6xl mx-auto px-6">
                <h2 className="text-4xl font-bold mb-10 text-center   text-black p-4 rounded-lg shadow-md">
                    Contact Us
                </h2>

                <p className="text-lg text-gray-700 text-center mb-12   p-6 rounded-lg shadow-md">
                ...
                {/* Social Media Links */}
                <div className="  p-6 rounded-lg shadow-lg mt-12 text-center">
                    <h3 className="text-2xl font-semibold mb-4 text-black">Follow Us</h3>
